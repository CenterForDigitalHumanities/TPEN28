...
import static textdisplay.ArchivedTranscription.getAllVersionsForPage;
...
public class GetHistory extends HttpServlet {
     ...
     *
     * This servlet creates the transcription and parsing history HTML for
     * transcription.html to use in #historySplit #historyListing. Please note
     * this servlet returns the entirety of the HTML. The request must contain
     * projectID and p, where p is the folio number.
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException, SQLException {
        ...
        Calendar m = getInstance(); //midnight
        ...
        pageno = parseInt(request.getParameter("p"));
        Map<Integer, List<ArchivedTranscription>> pageHistory = getAllVersionsForPage(projectID, pageno);
        Project thisProject = new Project(projectID);
        if (pageno < 0) {
            pageno = thisProject.firstPage();
        }
        thisText = getProjectTranscriptions(projectID, pageno);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            getLogger(GetHistory.class.getName()).log(SEVERE, null, ex);
        }
    }
