...
public class JsonImporter {
   ...
   public JsonImporter(Project proj, int u) throws SQLException {
      project = proj;
   ...
   private void insertTranscription(Map<String, Object> rowData, Folio f) throws IOException, SQLException {
      ...
      String cont = (String)rowData.get("content");
      String note = "";
      Transcription newTranscr = new Transcription(userID, project.getProjectID(), f.getFolioNumber(), cont, note, r);
   }
