...
/**
 *
 * update the positions of a bunch of Transcription lines. Usually an adjustment of the column width.
 */
public class batchUpdateLinePositions extends HttpServlet {
