...
/**
 * Output the line positions for a project or Manuscript in a simple xml format
 * 
 */
public class linePositions extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        {
            //must be a request for publicly available Manuscript parsing
            if(request.getParameter("msID")!=null)
            {
                ...
                out.append("<ms>"+m.getLinePositions()+"</ms>");
