...
/**
 *
 * Update the remaining text when a user is linebreaking a block of uploaded text to fit it to the lines in the image
 */
public class updateRemainingText extends HttpServlet {
