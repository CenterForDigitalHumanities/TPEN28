...
//                                $(this).parents('.exportPage').attr('data-pagenumber'),".",
            ...
            function linebreakContinuous(breakString){
                ...
                //rejoin broken words
                if (breakString){
                  $(".exportText").each(function(){
                    var wb = new RegExp(breakString,"g");
                    var joinedLine = $(this).text().replace(wb,'');
                    $(this).text(joinedLine);
  });
                }
            }
            var XML = {
                ...
                for (int i=0;i<folioLimit;i++){
                  ...
                  if (!Transcription.projectHasTranscriptions(projectID, eachFolio.getFolioNumber())){
                    ...
                    <div class="exportLine">
                      <span class="exportText">This page has no stored transcription.</span>
                    </div><%
                        continue;
                    } 
