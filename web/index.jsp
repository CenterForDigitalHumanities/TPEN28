...
//                        return(mdate.format('l, F jS, Y g:00a'));
//                    });
//            }
...
<%
    ...
    <%}%>
            ...
            <div id="header2">
                <div id="maintenance" class="loud"><span class="ui-icon ui-icon-info left"></span><span id="upgradeMessage"></span>Scheduled Maintenance: <script type="text/javascript">document.write(maintenanceDate());</script></div>
                    <%
